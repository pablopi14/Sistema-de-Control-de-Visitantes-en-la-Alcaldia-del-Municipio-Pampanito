...
import { Calendar as CalendarIcon, Loader2, Edit, Trash2, Eye, Users, FileText } from "lucide-react";
        ...
        <div className={cn(
          ...
          <Card className={cn(
            ...
            <CardHeader>
              ...
              <CardDescription>
                Mostrando registros para: {formattedDate} ({attendances.length} registros)
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loadingAttendances ? (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="hidden md:table-cell">Hora Salida</TableHead>
                    ...
                    <TableBody>
                      {attendances.map((attendance: Attendance) => (
                        <TableRow key={attendance.id}>
                          ...
                          <TableCell className="hidden md:table-cell">
                            {attendance.hora_salida ? attendance.hora_salida.slice(0, 5) : "N/A"}
                          </TableCell>
                          <TableCell>
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      Esta acción no se puede deshacer. Se eliminará permanentemente el registro de asistencia de {attendance.nombres} {attendance.apellidos}.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
