...
const ReportsPage = () => {
  ...
  const fetchReportData = async () => {
    ...
    try {
      ...
      const response = await apiService.reports.getReportData(filters);
  ...
  const generatePDFReport = async () => {
    ...
    try {
      ...
      const response = await apiService.reports.generatePDF(data);
  ...
  useEffect(() => {
    fetchReportData();
  }, [startDate, endDate, cedula, departamento]);
  ...
  const FiltersSection = () => (
    <Card className='h-fit'>
      <CardHeader className='pb-4'>
        ...
        <CardDescription>
          Selecciona el rango de fechas y filtros para generar el reporte
        </CardDescription>
      </CardHeader>
          ...
          <div className='space-y-2'>
            ...
            <Select value={departamento} onValueChange={setDepartamento}>
              ...
              <SelectContent>
                ...
                <SelectItem value='renta-y-licores'>Renta y licores</SelectItem>
    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader className='pb-4'>
          <CardTitle className='text-lg'>
            Motivos de Visita Más Populares
          </CardTitle>
          <CardDescription>
            Los motivos más frecuentes durante el período seleccionado
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className='pb-4'>
          ...
          <CardDescription>
            Personas que han visitado más de una vez en el período
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className='rounded-md border'>
    ...
    <div className='container mx-auto p-6 space-y-8'>
      <div className='text-center space-y-2'>
        ...
        <p className='text-muted-foreground'>
          Genera y visualiza reportes detallados de asistencia
        </p>
      </div>
